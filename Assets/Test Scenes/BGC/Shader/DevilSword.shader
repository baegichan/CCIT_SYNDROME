Shader "Custom/DevilSword"
{
    Properties
    {
        ...
        _Line1Alpha("Line1Alpha",Float)=0
        _Line2Alpha("Line2Alpha",Float)=0
    ...
    SubShader
    {
       ...
       float4 _RimPower;
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
            ...
            o.Emission = ((pow(1-rim,2)*_RimColor + test3*_HoloColor + test2*_HoloColor2)*0.5+0.5) *c.rgb*0.4;
            if(test3.r==0)
            {
              o.Alpha=_Line1Alpha;
            }
