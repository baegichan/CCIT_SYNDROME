...
public class MapData : ScriptableObject
{
    ...
    public void Batch_map()
    {
        ...
        Center = GameObject.Find("MapEditer");
    ...
    {
        if (Back_Ground_Sprite == null) return 0;
    ...
    public void Road_Default_TileMap()
    {
        if (Tile_Map == null)
        {
            
            this.Tile_Map = (GameObject)Resources.Load("Default Grid");
        }

    }
    public void Save_TileMap(GameObject TileMap)
    {
